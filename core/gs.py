...
class GaussianRenderer:
    ...
    def modified_render(self, gaussians, cam_view, cam_view_proj, cam_pos, bg_color=None, scale_modifier=1):
        # gaussians: [B, N, 14]
        # cam_view, cam_view_proj: [B, V, 4, 4]
        # cam_pos: [B, V, 3]
    ...
    def save_ply(self, gaussians, path, compatible=True, prune=True):
        # gaussians: [B, N, 14]
